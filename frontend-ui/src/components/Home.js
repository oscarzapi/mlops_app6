...
function Home() {
  return (
    <div className="App">
      <h1>Enter your details to get approval chance of your application</h1>
      <JsonForm></JsonForm>
    </div>
  );
}
...
class JsonForm extends Component {
  ...
  render(){
    ...
    <input type="text" name="Property_Area" value={this.state.Property_Area} onChange={this.handleChange} ></input></td>
              </tr>
            </tbody>
          </table>
